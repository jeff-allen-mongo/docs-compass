...
function addGetSSHTunnelCommands(client) {
  client.addCommand('getSSHTunnelText', function() {
    return this.getText('select[name=ssh_tunnel]');
  })
}
...
function addInputConnectCommands(client) {
  ...
  client.addCommand('selectSSHIdentityFile', function() {
      return this.selectByValue('select[name=ssh_tunnel]', 'IDENTITY_FILE');
  });
}
...
function addConnectCommands(client) {
  ...
  addGetSSHTunnelCommands(client);
