...
screenshots:
	rm -rf screenshot-tool/compass-screenshots-temp
	mkdir -p screenshot-tool/compass-screenshots-temp
	sudo rm -rf screenshot-tool/node_modules/mongodb-version-manager/.mongodb/mongodb-current
	cd screenshot-tool && sudo npm test
